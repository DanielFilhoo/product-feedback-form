    ...
    <div className="review-form">
      <div className="form-control score-container">
        ...
        <label className="radio-container">
          ...
          required checked={data.review === "unsatisfied"} onChange={(e) => updateFieldHandler("review", e.target.value)}/>
          <BsFillEmojiFrownFill />
          <p>Insatisfeito</p>
        </label>
      ...
      <div className="form-control">
        ...
        <textarea
          name="comment"
          id="comment"
          placeholder="Conte como foi sua experiência com nossos produtos..."
          required
          checked={data.comment || ""} onChange={(e) => updateFieldHandler("comment", e.target.value)}
        ></textarea>
      </div>
    </div>
  );
